  ...
  return (
   ...
   <div>
    ...
    <div className='dashboardmenulg h-[100%] bg-[#111] text-[#fff]' style={{zIndex:"999", position:"fixed", boxShadow:"2px 2px 2px 2px #502", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
       ...
       <Link href="https://scan.bohr.life"><img src="images/Botchain.png" width="30" className='ml-[0.3cm] rounded-[100%]' style={{display:"inline-block"}}/></Link>
     </div>
      <div>
   ...
   <div className='w-[70%] h-[100%] bg-[#111] text-[#fff]' data-aos="fade-right" style={{boxShadow:"2px 2px 2px 2px #502", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
       ...
       <Link href="https://scan.bohr.life"><img src="images/Botchain.png" width="30" className='ml-[0.3cm] rounded-[100%]' onClick={(e) => setMountSmallMenu(false)} style={{display:"inline-block"}}/></Link>
     </div>
      <div>
      ...
      <div className='mt-[20%] p-[0.5cm]' style={{display:"block"}}>
       <div><Link href="https://github.com/mrpatrick030/Real-World-Asset-Tokenisation-on-Botchain-Smart-Chain/blob/main/README.md"><button onClick={(e) => setMountSmallMenu(false)} className='m-[0.2cm] rounded-md bg-[#502] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link></div>
   ...
   <div className='w-[100%]'>
   <img src="images/Botchain.png" width="100" className='lg:mt-[10%] mt-[20%] ml-[5%] rounded-[100%] blurimage1' style={{position:"absolute"}} />
   <img src="images/Botchain.png" width="100" className='lg:mt-[15%] mt-[25%] lg:ml-[85%] ml-[65%] rounded-[100%] blurimage2' style={{position:"absolute"}} />
