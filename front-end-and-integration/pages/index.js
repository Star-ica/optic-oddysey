...
export default function Home(){
  ...
  return (
   ...
   <div className='text-center text-[150%] lg:text-[200%] md:text-[180%] pt-[1.5cm] font-[500] text-[#ddd]'>Explore, discover, tokenize and make your art/photos work for you on Botchain</div>
   ...
   <div className='mt-[1cm] text-center lg:text-[140%] text-[120%] lg:mx-[20%] md:mx-[10%] mx-[5%] p-[1cm] lg:px-[2cm] text-[#ccc] bg-[rgba(0,0,0,0.9)]' style={{border:"1px solid #502"}}>
    <div data-aos="fade-in" className='info1' style={{transition:"0.5s ease-in-out"}}>
     Optic Odyssey NFT Marketplace: Explore and tokenize your art/photos to NFTs on Botchain. The NFT marketplace is where all NFTs created on Optic Odyssey are being sold.
